        ...
        <div className='abc'>
          <div>
            {userNotifications.map((notification) => (
              ...
              <div>
                <button onClick={() => acceptRequest(notification.requesterId, notification.projectName, notification.projectId)}>Accept</button>
                <button onClick={() => declineRequest(notification.requesterId, notification.projectName, notification.projectId)}>Decline</button>
              </div>
            )}
              </div>
            ))}
